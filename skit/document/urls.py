...
# ex: /document/
    ...
    # ex: /document/employeeDocument-list/
    path('employeeDocument-list', login_required(views.EmployeeDocumentListView.as_view()),
    ...
    # ex: /employeeDocument/b26950fe-21c4-11e9-ab14-d663bd873d93/edit
